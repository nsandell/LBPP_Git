...
public class DiscreteEvidenceNode<Context> implements InnerNode<Context>, Serializable
{
	public DiscreteEvidenceNode(int cardinality, ContextManager<DiscreteDistribution,Context,DiscreteMessage,Integer> contextManager)
	{
