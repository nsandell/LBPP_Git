...
public interface ContextManager<DistributionType extends Distribution, ContextType,MessageType extends Message, ValueType>
{
	...
	void newParent(MessageType inc_pi, MessageType pi, MessageType outgoing_lambda, ContextType context);
	...
	//Parent/children can be managed in the instantiations.
	...
	Vector<MessageType> getParentLocalPis(ContextType context);
	...
	public void resetMessages(ContextType context);
	...
	double getLogLikelihood(ContextType context);
	void setLogLikelihood(ContextType context, double ll) throws BNException;
}
