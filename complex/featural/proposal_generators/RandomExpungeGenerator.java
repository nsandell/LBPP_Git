...
public class RandomExpungeGenerator implements MHProposalGenerator {
	...
	public MHProposal generate(FeaturalModelController cont)
	{
		...
		Vector<IFeaturalChild> expells = new Vector<IFeaturalChild>();
		...
		return new MHProposal(fp, bp, new ProposalAction.DisconnectAction(pair.l1,expells));
	}
